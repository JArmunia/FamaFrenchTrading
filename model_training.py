...
parser.add_argument('--data_store', type=str, default='data/assets_neutralized.h5',
                   help='Ruta al archivo H5 con los datos')
parser.add_argument('--data_store_item', type=str, default='engineered_features_trimmed',
